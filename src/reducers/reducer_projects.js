    ...
    return [
        ...
        },
        {
            ...
            tasks_features: [
                ...
                'Back and forth communication with the designer to go through multiple versions of animations to find the best one',
                'Optimizing performance to avoid negative impact of animating elements, especially on mobile devices',
                'Creating a WordPress blog located at - https://hulq.com/blog/ - in a similar design to the main landing page',
        ...
        },
        {
            ...
            type: 'One-man project',
            description: 'A tight-deadline project aimed at digital advertising. A full-page design and a large number of animations based on user actions provide a feel of high interactivity.',
            tasks_features: [
        ...
        },
        {
            ...
            type: 'Team project',
            description: 'A development on this website is going on for over 3 years. It has undergone massive design and structure changes, gained a lot of new features, which eventually led to signing a contract with Walmart and creating a "Walmart Associate" version of the website dedicated to providing exclusive prices for Walmart employees.',
            tasks_features: [
        ...
        },
        {
            ...
            type: 'Team project',
            description: 'A real-time bidding platform for one of the largest customer returns, refurbished and overstock product markets. Every day this website connects thousands of customers to the world\'s biggest retailers. Every little piece in this huge system must run smoothly in order to provide top quality service and make the bidding and buying process smooth and pleasant for all customers.',
            tasks_features: [
                'Technologies used: HTML, PHP, WordPress, WooCommerce, Grunt, Scss, vanilla JS, jQuery',
                'Implementing new designs on a regular basis to provide an up-to-date look of the website',
                'Constantly working on adding new features, to make the platform more appealing to businesses around the globe',
                'Ensuring that no visual or functional bugs appear as new features are developed by the backend team',
                'Frequently examining the entire website to check for potential bugs and suggesting possible design improvements',
                'Replacing old CSS with the new more organized structure, implementing new pages using Foundation CSS framework',
                'Setting up Grunt tasks to speed up the development process',
                'Writing a fair amount of php and WordPress related code'
            ],
            repository: 'Private repository, all code belongs to goTRG.'
        },
        {
            ...
            type: 'One-man project',
            description: 'The face of the goTRG company, meaning that this is arguably their most important project in terms of aesthetics. ',
            tasks_features: [
                ...
                'Heavily testing the entire website to make sure that new changes don\'t interfere with the rest of the website'
            ],
            repository: 'Private repository, all code belongs to goTRG.'
        },
        {
            ...
            type: 'Team project',
            description: 'A large online marketplace aimed at connecting major auction houses across the North America. Such ambitious project requires top quality of code to provide customers with the greatest user experience. The most modern technologies were used to make sure that the quality of the website and performance of every action match world\'s very best online projects.',
            tasks_features: [
                'Technologies used: HTML, JavaScript, MeteorJS, Scss',
                'Creating various components and widgets for the website',
                'Experimenting with CSS animations and transitions to achieve an appealing look and interactive feel for the applications',
                'Replacing old CSS with the new more organized structure, implementing new pages using Foundation CSS framework',
        ...
        },
        {
            ...
            type: 'One-man project',
            description: 'A project for the Frontend Udacity Nanodegree course, aimed at getting experience in writing OOP JavaScript using one of the popular MVC frameworks (KnockoutJS). The goal of the project is to use Google Map API to create an interactive map application, which would allow user to see nearby places of interest with additional information.',
            tasks_features: [
                ...
                'Showing a great degree of creativity by coming up with your own design and additional features to get additional credits for the assignment',
